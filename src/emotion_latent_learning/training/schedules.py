...
def current_loss_weights(epoch: int, ctx: ExperimentContext) -> Dict[str, float]:
    ...
    return {
        ...
        "edit_sensitivity_weight": ctx.loss_config.edit_sensitivity_weight,
